 ...
 <nav class="navbar navbar-default">
    ...
    <g:form action="save"  class="form-horizontal" role="form">
			...
			<div class="form-group">
				...
				<g:hasErrors bean="${model}" field="numberOfSeats">
	    		 	<g:eachError bean="${model}" field="numberOfSeats">
	    		 	<p style="color: red;"><g:message error="${it}"/></p>
	    		 	</g:eachError>
	    		</g:hasErrors>
				</div>
				...
				<g:hasErrors bean="${model}" field="engineCapacity">
	    		 	<g:eachError bean="${model}" field="engineCapacity">
	    		 	<p style="color: red;"><g:message error="${it}"/></p>
	    		 	</g:eachError>
	    		</g:hasErrors>
				</div>
				...
				<g:hasErrors bean="${model}" field="enginePerformance">
	    		 	<g:eachError bean="${model}" field="enginePerformance">
	    		 	<p style="color: red;"><g:message error="${it}"/></p>
	    		 	</g:eachError>
	    		</g:hasErrors>
				</div>
